...
$(window).load(function(){
   ...
   for(i=1;i<items.length;i++){
       if(items[i]==1){
           ...
           html =html+ " <a href='https://concurvas.com/team/cambios'><div class='accesos' > <img src='<?php echo get_template_directory_uri(); ?>/imagenes/iconos/ventas.png' alt='Avatar'></div></a>";
       }if(items[i]==4){
