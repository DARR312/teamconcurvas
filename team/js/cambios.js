...
function imprimirCambiosjson(ordenesCambio,pedidoUpdate,fechaUpdate,notasUpdate,usuarioUpdate){
    ...
    if(jsonCambios.length>0){
        for(i=1;i<jsonCambios.length;i++){
            ...
            imprimir = imprimir+"<td>C"+jsonCambios[i].estado+"</td><td>"+datosdelcliente[1]+"</td><td>"+datosdelcliente[5].substr(0, datosdelcliente[5].length - 1)+"</td><td>"+datosdelcliente[2]+"</td><td>"+datosdelcliente[3]+"</td><td>"+datosdelcliente[4]+"</td><td>"+precioFormato+"</td><td>"+jsonCambios[i].pedido+"</td><td>"+jsonCambios[i].notas+"</td></tr>";
        }        
    }
    html = html + imprimir +"</table></div>";
    return html;
